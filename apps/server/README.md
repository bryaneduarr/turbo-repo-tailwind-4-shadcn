...
- **Scalar API Docs**: Beautiful API reference at `/reference`
...
All routes and schemas are documented and available at the `/reference` endpoint. This is built with [Scalar](https://github.com/scalar/scalar).
